...
import ar.edu.unq.tpi.persit.ball.persistencia.criteria.Criteria;
...
public class CriteriaHibernateImpl implements Criteria<Criterion>{
	...
	public  CriteriaHibernateImpl distint(String property, String value) {
		return new CriteriaHibernateImpl(Restrictions.ne(property, value));
	}

	public  CriteriaHibernateImpl greater(String property, String value) {
	...
	public  CriteriaHibernateImpl greaterOrEqual(String property, String value) {
