...
public interface Criteria<T> {
	...
	public Criteria<T> distint(String property, String value);

	public Criteria<T> greater(String property, String value);

	public Criteria<T> less(String property, String value);

	public Criteria<T> lessOrEqual(String property, String value);

	public Criteria<T> greaterOrEqual(String property, String value);
